...
public class Main {
    public static void main(String[] args) {
        TaskManager manager = new FileBackedTaskManager("src/main/resources/manager 1/dataTo.csv", "src/main/resources/manager 1/dataFrom");
//
...
//        TaskManager manager1 = FileBackedTaskManager.loadFromFile("src/main/resources/manager 2/dataFrom.csv","src/main/resources/manager 2/dataTo");
